...
def profilMenu(id_profil):
    ...
    cursor.execute("SELECT high_score FROM record WHERE id_profil = ? and id_mini = ?", (id_profil,3))
    score_3 = cursor.fetchone()
    if score_3 == None:
        score_3 = 0
    else :
        score_3 = score_3[0]
    ...
    while continuer_profil:
        ...
        afficher_record(score_2, 'profilMenu', 2)
        afficher_record(score_3, 'profilMenu', 3)
...
def bonus(id_profil):
    ...
    route = pygame.Rect(0.38*largeur, 0.56*hauteur, largeur/11, hauteur/9)
    liste_boutons = [retour, lavage, flappy, route]
    ...
    while continuer_bonus:
        ...
        afficher_record(score_2, 'bonus', 2)
        afficher_record(score_3, 'bonus', 3)
